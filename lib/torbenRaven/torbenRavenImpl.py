...
This module wraps the Raven assembler as a KBase App.
    ...
    def run_torbenRaven(self, ctx, params):
        """
        ...
        #BEGIN run_torbenRaven

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_torbenRaven function. Params=' + pformat(params))
        ...
        if not isinstance(output, dict):
            raise ValueError('Method run_torbenRaven return value ' +
